...
trait AccessControlTrait
{
    ...
    /**
     * The access control cache tag used by the user model.
     *
     * @return string
     */
    public static function getAccessControlTag()
    {
        return 'access-control.users';
    }
    ...
    */
    ...
    public function assignRole($roleId = null)
    {
        ...
        if (!is_numeric($roleId)) {
            $roleId = \pierresilva\AccessControl\Models\Role::where('slug', $roleId)->pluck('id')->first();
        }
    ...
    */
    ...
    public function __call($method, $arguments = [])
    {
        ...
        if (Str::startsWith($method, 'is') and $method !== 'is') {
            $role = Str::kebab(substr($method, 2));
